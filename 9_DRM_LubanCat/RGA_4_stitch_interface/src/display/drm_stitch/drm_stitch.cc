...
private:
    ...
    int displaytype = DisplayType::Contain;
    int dst_dma_fd;
...
// 外部类接口转发
VideoStitch::VideoStitch() : impl(new Impl()) {}
VideoStitch::~VideoStitch() { delete impl; }
...
int main(int argc, char **argv)
{
    ...
    // 初始化指针
    video = std::make_shared<VideoStitch>();
